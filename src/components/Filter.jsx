  ...
  return (
    <>
      <div className="collapse container m-auto mb-7">
        ...
        <div className="collapse-content flex gap-x-44 gap-y-10 flex-wrap justify-center bg-gray-50 rounded-2xl capitalize " style={{ color: '#4056a1' }}>
          {/* Diet filter */}
          <div className="flex flex-col">
            <label className="label cursor-pointer justify-start gap-2">
              <span className="font-medium text-zinc-950 text-lg" style={{ color: '#6B4C11' }}>Diet</span>
            </label>
          ...
          <div className="flex flex-col">
            <label className="label cursor-pointer justify-start gap-2">
              <span className="font-medium text-zinc-950 text-lg"style={{ color: '#6B4C11' }}>
                Meal Types
              </span>
            </label>
            <label className="label cursor-pointer justify-between gap-2">
