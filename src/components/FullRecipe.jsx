...
export default function FullRecipe() {
  ...
  return (
    <>
      ...
      <div className="container flex flex-col items-start text-[#183a1d] m-auto text-left  text-zinc-950  md:px-24 p-4 ">
        <div className="flex justify-between w-full">
          <img
            src={image}
            alt={label}
            className="mb-4 aspect-video w-[500px] h-[240px] object-cover rounded-md"
          />
          {showTip && <TipOfTheDay />}
        </div>
